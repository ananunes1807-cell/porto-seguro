...
function cancelarRelatorio(){estado.relatorioAtual=null;$('#texto-relatorio-editavel').value='';$('#contador-palavras-relatorio').textContent='';$('#resultado-relatorio').hidden=true}
